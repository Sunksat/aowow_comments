...
-- ----------------------------
-- Table structure for `aowow_comments_wh`
-- ----------------------------
DROP TABLE IF EXISTS `aowow_comments_wh`;
CREATE TABLE `aowow_comments_wh` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2529757 DEFAULT CHARSET=utf8 COMMENT='udwbase Comments Table';